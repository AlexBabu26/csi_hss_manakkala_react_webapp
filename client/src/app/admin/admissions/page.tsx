    ...
    return (
        <div className="animate-fade-in max-w-4xl">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-3xl font-bold text-zinc-900 dark:text-white">Manage Admissions</h1>
            ...
            <form onSubmit={handleSave} className="bg-white dark:bg-zinc-800 p-6 rounded-lg shadow border border-zinc-200 dark:border-zinc-700 space-y-6">
                <div className="space-y-4">
                    <div>
                        <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300">Admission Process Info</label>
                        <textarea rows={6} defaultValue="We welcome students who can benefit from our specialized educational environment..." className={inputClasses}></textarea>
                    </div>
                </div>
