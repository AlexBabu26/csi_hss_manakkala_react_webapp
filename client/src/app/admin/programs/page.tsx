    ...
    return (
        <div className="animate-fade-in max-w-4xl">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-3xl font-bold text-zinc-900 dark:text-white">Manage Programs</h1>
            ...
            <form onSubmit={handleSave} className="bg-white dark:bg-zinc-800 p-6 rounded-lg shadow border border-zinc-200 dark:border-zinc-700 space-y-6">
                {/* Mocked up Program Section */}
                <div className="space-y-4">
                    <div>
                        <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300">Program Title</label>
                        <input type="text" defaultValue="Academic Curriculum" className={inputClasses} />
                    </div>
                    <div>
                        <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300">Description</label>
                        <textarea rows={4} defaultValue="Our core academic program follows the state syllabus, adapted with specialized teaching methods..." className={inputClasses}></textarea>
                    </div>
                </div>
